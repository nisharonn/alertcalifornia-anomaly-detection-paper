...
In the testing set, we introduce three additional cameras: Axis-ToroPeak1 \footnote{\url{https://cameras.alertcalifornia.org/?pos=38.6603_-122.1906_10&id=Axis-ToroPeak1}}, Axis-Dewdrop1 \footnote{\url{https://cameras.alertcalifornia.org/?pos=33.5202_-116.4297_10&id=Axis-Dewdrop1}}, and Axis-Berryessa \footnote{\url{https://cameras.alertcalifornia.org/?pos=33.3598_-116.8595_10&id=Axis-Berryessa}}, which we refer to as Toro Peak, Dew Drop, and Berryessa. In this set, Toro Peak and Dew Drop are seasonal cameras, while Berryessa does not show substantial change across seasons. We select Dew Drop and Berryessa, located in Amador and Yolo Counties in Northern California, to evaluate the model's ability to generalize across geographic regions. Toro Peak, also located in Southern California in Riverside County, is selected to assess seasonal effects in a similar area. This configuration allows us to assess model performance across both seasonal variability and geographic context. Example images from each location are shown in Figure~\ref{fig:level_examples}. 
...
We additionally test generalizability by evaluating on three new unseen datasets: Berryessa, Dew Drop, and Toro Peak. Table~\ref{tab:camera_accuracies} lists the accuracy, precision, and recall values. 
...
\begin{figure}[h!]
    ...
    \begin{minipage}{\textwidth}
        ...
        \begin{subfigure}{0.31\textwidth}
            \centering
            \includegraphics[width=\linewidth]{figures/coronado_hills_roc.jpg}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.31\textwidth}
            \centering
            \includegraphics[width=\linewidth]{figures/mesa_grande_roc.jpg}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.31\textwidth}
            \centering
            \includegraphics[width=\linewidth]{figures/palomar_roc.jpg}
        \end{subfigure}
    ...
    \begin{minipage}{\textwidth}
        ...
        \begin{subfigure}{0.31\textwidth}
            \centering
            \includegraphics[width=\linewidth]{figures/berryessa_roc.jpg}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.31\textwidth}
            \centering
            \includegraphics[width=\linewidth]{figures/dewdrop_roc.jpg}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.31\textwidth}
            \centering
            \includegraphics[width=\linewidth]{figures/toropeak_roc.jpg}
        \end{subfigure}
    ...
    \caption{\ac{ROC} curves at all training (a-c) and testing (b-e) camera locations.}
...
\subsection{Final Multi-Camera Model}
The final multi-camera model trained with triplet loss demonstrates relatively strong performance across all three camera locations in its training set. Table~\ref{tab:train_test_accs} shows test accuracies above $90\%$ for both seasonal and non-seasonal cameras, indicating that the model generalizes effectively to unseen environmental variations present in the training distribution. Among these locations, Coronado Hills achieves the highest overall performance and is the only site where recall exceeds precision. This suggests that the model is particularly effective at identifying a larger proportion of \ac{QoS} anomalies at this location. The tradeoff, however, is more false positives. 
...
Despite the reduction in precision, Figure~\ref{roc_curves} show that all camera locations achieve \ac{AUC} values above 0.90. These results indicate that the model has strong discriminative ability that effectively separates Normal and Abnormal frames. The discrepancy between the high \ac{AUC} values and lower precision suggests that classification accuracy may be more sensitive to the selected decision threshold, and that the model’s anomalous discrimination remains reliable. 

Performance also varies across individual camera locations within this unseen dataset. Interestingly, Dew Drop and Toro Peak, both identified as seasonal cameras, outperform Berryessa, a location that does not observe significant environmental variability throughout seasons. With Dew Drop and Toro Peak accuracies in the mid-80\% range compared to Berryessa’s 60.40\%, these results indicate that rather than seasonal factors, the model’s ability to generalize is more heavily influenced by other environmental characteristics. 
