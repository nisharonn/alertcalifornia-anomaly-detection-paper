...
Level 1 - Clear  & 1109  & 1515 & 1512 & 4136 & 178 & 165 & 138 & 481 \\
Level 2 - Minor  & 732  & 133  & 252  & 1117 & 50  & 34  & 36  & 120 \\
\textbf{Normal}  & 1841 & 1648 & 1764 & 5253 & 228 & 199 & 174 & 601 \\

\midrule

Level 3 - Major  & 206  & 86  & 180  & 472  & 19  & 12  & 7  & 38 \\
Level 4 - Severe & 278  & 181   & 97  & 556 & 9  & 1  & 21  & 31 \\
\textbf{Abnormal}& 484  & 267  & 277  & 1028 & 28  & 13  & 28  & 69 \\

\midrule

\textbf{Labeled}   & 2325 & 1915 & 2041 & 6282 & 256  & 212  & 202  & 670\\
\textbf{Unlabeled} & 5163 & 6003 & 4822 & 15988& 7167 & 7777 & 6947 & 21891 \\

\midrule

\textbf{Total} & 7488 & 7918 & 6863 & 22270 & 7423 & 7989 & 7149 & 22561 \\
...
\begin{itemize}
    ...
    \item\textbf{Level 2 – Minor Anomaly:} Translucent obstructions (<50\% of the \ac{ORR}) cause partial obstruction of the camera’s field of view. The camera remains reliable for response operations.
    \item\textbf{Level 3 – Major Anomaly:} Opaque obstructions (<50\% of the \ac{ORR}) cause partial obstruction of the camera’s field of view. The camera may not be reliable for response operations.
    \item\textbf{Level 4 – Severe Anomaly:} An obstruction covers more than 50\% of the \ac{ORR}. The camera is unreliable for response operations.                   
\end{itemize}

Four annotators review each image to ensure labeling consistency and reduce subjective bias. The final label is determined by majority opinion, in which at least 3 annotators agree. Images with conflicting or tied labels are separately addressed in a team meeting to reach a consensus. We obtain a total of 6,282 labeled images for our training set (see Table~\ref{tab:frame_counts} for complete counts). Figure~\ref{fig:level_examples} highlights examples of each level across cameras using this labeling scheme. 

Once we obtain our labeled dataset, we downsample and standardize the images to a size of 224 x 224 pixels with 3 channels, then convert them into tensors of size 224 x 224 x 3. In their processed form, our images have 150,528 features each.  We then split the larger dataset into training and test sets with an 80\% training and 20\% test split. Finally, the training, validation, and test splits are divided into batches of size 32 to maximize the computational power of a single \ac{GPU} during training. 
...
\[\left|\mathbf{e_T}\right| = \left|\mathbf{e_D}\right| = \left|\mathbf{e_H}\right| =X\]
...
The final multi-camera model demonstrates XXX performance across all three camera locations in its training set. Table~\ref{tab:train_test_accs} shows XXX accuracies on XXX, indicating the model (does/does not) generalizes to unseen environmental variations present in the training distribution. 
