...
We additionally test generalizability beyond the training distribution by evaluating on three new unseen datasets: Berryessa, Dew Drop, and Toro Peak. Table~\ref{tab:camera_accuracies} lists the balanced accuracy, precision, and recall values. 
