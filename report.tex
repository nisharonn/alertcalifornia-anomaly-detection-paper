...
Each image is reviewed by a minimum of three annotators to ensure labeling consistency and reduce subjective bias. The final label is determined by majority opinion. Images with conflicting or tied labels are separately addressed in a team meeting to reach a consensus. We obtain a total of 6,269 labeled images for our training set (see Table~\ref{tab:frame_counts} for complete counts). Figure~\ref{fig:level_examples} highlights examples of each level across cameras using this labeling scheme. 
