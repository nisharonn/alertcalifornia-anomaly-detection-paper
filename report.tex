...
Level 1 - Clear  & X  & X & X & X & X & X & X  & X \\
Level 2 - Minor  & X  & X  & X  & X & X  & X  & X  & X \\
\textbf{Normal}  & X & X & X & X & X & X & X & X \\

\midrule

Level 3 - Major  & X  & X  & X  & X  & X  & X  & X  & X \\
Level 4 - Severe & X  & X   & X  & X  & X  & X  & X  & X \\
\textbf{Abnormal}& X  & X  & X  & X & X  & X  & X  & X \\

\midrule

\textbf{Labeled}   & 2325 & 1915 & 2042 & 6282 & 256  & 212  & 202  & 670\\
\textbf{Unlabeled} & 5163 & 6003 & 4822 & 15988& 7167 & 7777 & 6947 & 21891 \\
...
In our objective selection process, we train and evaluate each baseline model on the Coronado Hills dataset using 4-fold cross-validation. We then take the mean and standard deviation of the training and validation accuracy across these folds. We repeat this process across five different randomly selected training seeds, taking the average of the means and \ac{SDs}.  Table~\ref{tab:train_val_accs} summarizes the results of this analysis. 
...
Average training \ac{SD} & 0.0015 & 0.0062 & 0.0316 \\
Average mean validation accuracy & 0.9260 & 0.9094 & 0.6903 \\
Average validation \ac{SD} & 0.0105 & 0.0177 & 0.0300 \\
...
We adopt triplet loss in our final model architecture due to its superior performance in baseline evaluations. The final multi-camera model is trained on data from Coronado Hills, Mesa Grande, and Palomar Observatory. We further assess intra-dataset performance by testing the model on unseen samples from these three locations. Table~\ref{tab:train_test_accs} reports the training and test accuracies, as well as recall and precision.
