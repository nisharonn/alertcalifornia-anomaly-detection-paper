...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/label_flowchart2.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/mlp_class_head.png}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/triplet_3d.png}
        \subcaption{Triplet Loss}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/deepsad_3d.png}
        \subcaption{DeepSAD}
    \end{subfigure}
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/hsad_3d.png}
        \subcaption{H-SAD}
    \end{subfigure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.85\linewidth]{figures/final_location_1v2.png}
...
\begin{figure}[h!]
    ...
    \begin{minipage}{\textwidth}
        ...
        \begin{subfigure}{0.31\textwidth}
            \centering
            \includegraphics[width=\linewidth]{figures/level1.jpg}
            \subcaption{Coronado Hills}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.31\textwidth}
            \centering
            \includegraphics[width=\linewidth]{figures/mesagrande_level1.jpg}
            \subcaption{Mesa Grande}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.31\textwidth}
            \centering
            \includegraphics[width=\linewidth]{figures/palomar_level1.jpg}
    ...
    \begin{minipage}{\textwidth}
        ...
        \begin{subfigure}{0.31\textwidth}
            \centering
            \includegraphics[width=\linewidth]{figures/berryessa_level1.jpg}
            \subcaption{Berryessa}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.31\textwidth}
            \centering
            \includegraphics[width=\linewidth]{figures/dewdrop_level1.jpg}
            \subcaption{Dew Drop}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.31\textwidth}
            \centering
            \includegraphics[width=\linewidth]{figures/toropeak_level1.jpg}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\linewidth]{figures/pc1vpc2.png}
